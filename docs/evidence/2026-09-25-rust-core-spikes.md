...
| 13 | What does it cost? | See the timing table. Native Rust roughly matches the current ports. Wasm costs about 5.3 times the current `node:crypto` build (3.5 times `/web`). wazero costs about 30 times the current Go port. |

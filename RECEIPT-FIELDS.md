...
| 25 | unknown | INTEGER | no | genuine only | | `3` in both fixture receipts. TPInAppReceipt: "reserved for future use". Confirmed the same value in a genuine production receipt too (2026-09-21, not committed). Also 3 in all three receipts examined on 2026-09-22 (not committed). |
...
| 1710 | unknown | INTEGER | no | genuine | | `0` throughout the fixture corpus. TPInAppReceipt names it `unknown_1710`. A genuine production receipt (2026-09-21, not committed) carried a nonzero value there, the same shape as type 11 — still unnamed beyond that. The 2026-09-22 re-examination (not committed) found 0 in both sandbox receipts and a ten-digit nonzero integer in the production receipt only, the same shape as type 11. |
